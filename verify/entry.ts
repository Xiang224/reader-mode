...
import { checkEligibility, checkPageCapabilities, readEligibilityInput } from '../lib/page/eligibility';
...
import { createReaderRuntime, getAdaptation, listAdaptations } from '../lib/readerRuntime';
import { rewriteMode } from '../lib/adaptations/rewriteMode';
import * as fixtures from './fixtures';

(window as any).RM = {
  styleStore, extractPage, checkEligibility, checkPageCapabilities, readEligibilityInput,
  fontSize, lineSpacing, contrast, hideAds, highlight,
  getAdaptation, listAdaptations, withDefaults,
